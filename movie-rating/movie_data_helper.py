...
def get_movie_id_list():
    ...
    return np.loadtxt("movie-rating/data/movieNames.dat",
                      dtype='int32',
                      delimiter='\t',
                      usecols=(0,))
...
def get_movie_name(movie_id):
    ...
    # ERROR CHECK
    #
    filename_to_check = "movie-rating/data/ratingsMovie%d.dat" % movie_id
    ...
    filename = "movie-rating/data/movieNames.dat"
...
def get_ratings(movie_id):
    ...
    filename = "movie-rating/data/ratingsMovie%d.dat" % movie_id
